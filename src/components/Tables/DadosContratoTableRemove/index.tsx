...
import RemoveEmployeeModal, { useRemoveEmployeeModal } from '@/components/Modal/RemoveEmployeeModal';
import * as S from './styles';

export function DadosContratoTableRemove() {
  const dados = [
    { contrato: 'XYZ', name: 'Lucas Pavanelli', cpf: '499.124.848-11', parcela: '12', valor: '600,00' },
    { contrato: 'XYZ', name: 'Lucas Pavanelli', cpf: '499.124.848-11', parcela: '12', valor: '600,00' },
    { contrato: 'XYZ', name: 'Lucas Pavanelli', cpf: '499.124.848-11', parcela: '12', valor: '600,00' },
    { contrato: 'XYZ', name: 'Lucas Pavanelli', cpf: '499.124.848-11', parcela: '12', valor: '600,00' },
    { contrato: 'ABC', name: 'Taynara Weber', cpf: '666.666.666-66', parcela: '6', valor: '666,00' },
    { contrato: 'ABC', name: 'Taynara Weber', cpf: '666.666.666-66', parcela: '6', valor: '666,00' },
    { contrato: 'ABC', name: 'Taynara Weber', cpf: '666.666.666-66', parcela: '6', valor: '666,00' },
    { contrato: 'ABC', name: 'Taynara Weber', cpf: '666.666.666-66', parcela: '6', valor: '666,00' },
    { contrato: 'αβγ', name: 'Túlio Panza', cpf: '000.000.000-00', parcela: '2', valor: '333,00' },
    { contrato: 'αβγ', name: 'Túlio Panza', cpf: '000.000.000-00', parcela: '2', valor: '333,00' },
    { contrato: 'αβγ', name: 'Túlio Panza', cpf: '000.000.000-00', parcela: '2', valor: '333,00' },
    { contrato: 'αβγ', name: 'Túlio Panza', cpf: '000.000.000-00', parcela: '2', valor: '333,00' },
    { contrato: 'XYZ', name: 'Lucas Pavanelli', cpf: '499.124.848-11', parcela: '12', valor: '600,00' },
  ...
  const { isShowingRemove, toggleRemove } = useRemoveEmployeeModal();
  const nomeFuncionario = dados[0].name;
  ...
  return (
    <>
      <RemoveEmployeeModal nomeFuncionario={nomeFuncionario} {...{ isShowingRemove, toggleRemove }} />
      <S.StyledTable>
        <thead>
          <S.StyledTr>
            <S.StyledTdTitle colSpan={6}>Detalhes do Contrato</S.StyledTdTitle>
          </S.StyledTr>
          <S.StyledTr>
            <S.FiltersWrapper colSpan={6}>
              <SearchSetup />
            </S.FiltersWrapper>
          </S.StyledTr>
          <S.StyledTr>
            ...
            <S.StyledTr key={index}>
              ...
              <S.StyledTd>
                <S.ActionButtonWrapper>
                  <ActionButton type='employee-out' onClick={toggleRemove} />
                </S.ActionButtonWrapper>
              </S.StyledTd>
            </S.StyledTr>
          ))}
...
export default DadosContratoTableRemove;
