...
export function AddFuncionariosTable() {
  const dados = [
...
// fim da lógica de paginação ==========
  return (
    <S.StyledTable>
      <thead>
        <S.StyledTr>
          <S.StyledTdTitle colSpan={4}>Funcionários Retirados</S.StyledTdTitle>
        </S.StyledTr>
        <S.StyledTr>
          <S.FiltersWrapper colSpan={4}>
            <SearchSetup />
          </S.FiltersWrapper>
        </S.StyledTr>
        <S.StyledTr>
...
export default AddFuncionariosTable;
